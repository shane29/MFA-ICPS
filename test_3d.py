...
from utils.test_patch import test_all_case, test_single_case_average_output
...
snapshot_path = FLAGS.root_path + "model/{}_{}_labeled/{}".format(FLAGS.dataset_name, FLAGS.labelnum, FLAGS.model)
test_save_path = FLAGS.root_path + "model/{}_{}_labeled/{}_predictions/".format(FLAGS.dataset_name, FLAGS.labelnum, FLAGS.model)
...
def test_calculate_metric():
    ...
    save_mode_path = os.path.join(snapshot_path, 'best_model.pth'.format(FLAGS.model))
...
# def show_image():
#     net = net_factory(net_type='vnet', in_chns=1, class_num=num_classes, mode="test")
#     save_mode_path = os.path.join(snapshot_path, 'vnet_best_model.pth'.format(FLAGS.model))
#     net.load_state_dict(torch.load(save_mode_path), strict=False)
#     print("init weight from {}".format(save_mode_path))
#     net.eval()
#
#     if FLAGS.dataset_name == "LA":
#         seg_image, att_image = test_all_case(FLAGS.model, 1, net, image_list, num_classes=num_classes,
#                                    patch_size=(112, 112, 80), stride_xy=18, stride_z=4,
#                                    save_result=True, test_save_path=test_save_path,
#                                    metric_detail=FLAGS.detail, nms=FLAGS.nms)
#
#     return seg_image, att_image
